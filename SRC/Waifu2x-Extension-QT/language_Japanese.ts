...
このオプションを有効にすることをお勧めします。</translation>
 ...
 processed again when the processing process is started again.</source>
        <translation>リストに完成したファイルがある場合、完成したファイルは
&#xa0; 処理プロセスが再び開始されると、再び処理されます。</translation>
    ...
    <message>
        ...
        <translation>選択したファイルをファイルリストから削除します。</translation>
    </message>
    <message>
...
resolution in the Additional settings.</source>
        <translation>デフォルトでは、結果画像のアスペクト比は元の画像と同じになります。
（したがって、画像は奇妙に見えません。）
追加設定でカスタム解像度のアスペクト比設定を変更できます。</translation>
    ...
    <message>
        ...
        <translation>出力パスはフォルダでなければなりません。</translation>
    </message>
    <message>
...
path] or [Delete original files] is enabled*</source>
        <translation>ファイルを処理した後、元のファイルを結果ファイルに直接置き換えます。
...
3. [適用]ボタンをクリックして、解像度を設定します。</translation>
    </message>
    <message>
...
正常に処理される）</translation>
    ...
    <message>
        ...
        <translation>アスペクト比(カスタム解像度):</translation>
    </message>
    <message>
...
process at the same time when processing a video.</source>
        <translation>ソフトウェアがビデオフレームを処理するスレッドの数、
...
process at the same time when processing a GIF.</source>
        <translation>ソフトウェアがGIFフレームを処理するスレッドの数、
...
original files] is disabled*</oldsource>
        <translation>[元のファイルを削除]が有効になっている場合は、元のファ
...
★Anime4K engine does NOT supports alpha channel.★</oldsource>
        <translation type="vanished">画像でアルファチャネルが検出されると、ソフトウェアは
画像を自動的にPNGとして保存します。</translation>
    </message>
    <message>
...
waifu2x-caffe  [ Speed:★☆  Image Quality:★★★ ]
Realsr-ncnn-vulkan [ Speed:☆  Image Quality:★★★ ]</source>
        <translation>[Python extension, FFmpeg, FFprobe, ImageMagick, Gifsicle, SoX]は、このソフトウェアのすべての機能を使用できることを確認するために、コンピューターと互換性がある必要があります。
...
by the software will be used.</source>
        <translation>このオプションを有効にすると、カスタマイズされたパラメーター
ビデオの処理時に使用されます。
...
Anime4k GPUリスト（ユーザー構成）：
    ...
    <message>
        ...
        <translation>Anime4KのGPUリスト</translation>
    </message>
    <message>
        <source>Retry</source>
...
ソフトウェアを再起動して有効にします。</translation>
    ...
    <message>
        ...
        <translation>サフィックスを追加します.(_W2xEX)</translation>
    </message>
    <message>
...
Waifu2x-converterプロセッサリスト:
    ...
    <message>
        ...
        <translation>]にアルファチャネルが含まれていることが検出されたため、結果の画像は強制的にPNGとして保存されます。</translation>
    </message>
    <message>
...
それでも互換性がない場合は、グラフィックスドライバーをアンインストールして再インストールし、Windows OSを更新してください。</translation>
    ...
    <message>
        ...
        <translation>]。 エラー：[スケーリングされた画像を.jpgとして保存できません。]</translation>
    </message>
    <message>
        <location filename="Anime4K.cpp" line="336"/>
        <location filename="realsr_ncnn_vulkan.cpp" line="412"/>
