...
*We recommend that you install this update after finish processing all the Video in the Files list.*
*This version is not compatible with the cache generated by the old version of the software.*
